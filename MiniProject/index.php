        ...
        <div class="welcome-area" id="welcome">
            <div class="header-text">
                <div class="deskripsi-home">
                    ...
                    <p class="welcome-paragraph content-left">Aplikasi olahraga terbaru yang memiliki informasi lengkap
                        tentang bidang olahraga dan bela diri. <br> Disini kamu dapat belajar cara untuk mempersehat
                        tubuh maupun jiwa.
                    </p>
                </div>
                <a href="kategoriWorkout.php" class="main-button-slider content-left" id="button1">Lihat Workouts</a>
                <a href="Training.html" class="main-button-slider content-left" id="button2">Lihat Training</a>
                <div class="homeimg">
                    <img id="before1" alt="">
                    <img id="before2" alt="">
                </div>
