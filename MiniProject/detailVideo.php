    ...
    <main class="content-cardio">
        <div class="video-container">
            <div class="video-embed">
                <iframe src="<?php echo $arrayVideo['linkVideo']; ?>" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen>
                </iframe>
            </div>
            <dl class="deskripsi-video">
                <a class="back-button" href="detailWorkout.php?id=<?php echo $arrayVideo['idKategori']; ?>"><b><i
                            class="fa fa-angle-left fa-lg"></i> Go Back </b></a>
                <a class="edit-button"
                    href="formDetailWorkout/editformDW.php?id=<?php echo $arrayVideo['idVideo']; ?>"><b><i
                            class='fa fa-edit' style='font-size:24px'></i> Edit </b></a>
